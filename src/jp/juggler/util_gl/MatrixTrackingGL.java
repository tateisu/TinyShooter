 ...
 * driver.
 */
public class MatrixTrackingGL implements GL10Ext, GL11, GL11Ext {
    GL10 mgl;
    GL10Ext mgl10Ext;
    GL11 mgl11;
    GL11Ext mgl11Ext;

    MatrixStack mModelView  = new MatrixStack();
    MatrixStack mTexture    = new MatrixStack();
    MatrixStack mProjection = new MatrixStack();
    ...
    public MatrixTrackingGL(GL gl,LogCategory log) {
    	log.d("GL class=%s",gl.getClass().getName());
        mgl = (GL10) gl;
        if (gl instanceof GL10Ext ) mgl10Ext = (GL10Ext) gl;
        if (gl instanceof GL11    ) mgl11    = (GL11   ) gl;
        if (gl instanceof GL11Ext ) mgl11Ext = (GL11Ext) gl;
        mCurrent = mModelView;
     ...
     */
    public static void getMatrix(GL10 gl, int mode, float[] mat) {
